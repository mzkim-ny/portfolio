...
- **해석**: 영화관 매출액 및 관객수는 2020년 최저치를 기록한 후 점차 증가하고 있다. 2019년 대비, 2023년 매출액은 약 65%, 관객수는 약 55% 회복한 것으로 보인다.
...
- **해석**: 가장 많이 대출한 분야는 문학(50%)으로, 사회과학(13%), 자연과학(8%)이 다음 순이다. 이는 십진분류별 소장도서의 비율(문학(41%), 사회과학(16%), 역사(8%))의 순서와 유사하나, 비율에서 차이를 보이는 것으로 여겨진다.<br><br/>
