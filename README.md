...
- **제언**: 2024년, 1인 피자를 출시하는 고피자는 매장 수가 1,200개로 증가하였습니다. 다른 브랜드에서도 가격을 낮추거나 크기를 줄인 1인 피자를 연이어 출시하고 있습니다. 1인 가구 피자 수요가 늘어나고 있다면, S사이즈를 가장 많이 주문하는 목요일 12시에, 인기 메뉴에 한정하여 할인 쿠폰을 발행하는 이벤트를 제안합니다.
