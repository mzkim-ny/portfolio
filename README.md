...
#### **# 남양주시 정약용도서관에서는 어떤 책을 많이 봤을까? (Excel)  - [태블로](https://public.tableau.com/views/_17196652852140/1?:language=ko-KR&:sid=&:display_count=n&:origin=viz_share_link)**
- **데이터**: 남양주시 정약용도서관 장서 대출목록(2024.05)
- **목적**: 십진분류별 남양주시민의 독서 취향을 확인하기 위함
- **해석**: 
