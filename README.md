...
#### **# 정약용도서관에서는 어떤 책이 많이 대출되었을까? (Excel)  - [태블로](https://public.tableau.com/views/_17196652852140/1?:language=ko-KR&:sid=&:display_count=n&:origin=viz_share_link)**
- **데이터**: 남양주시 정약용도서관 장서 대출목록(2024.05)
- **목적**: 정약용도서관 이용자의 독서 취향을 십진분류별로 확인하기 위함
- **해석**: 가장 많이 대출한 분야는 문학(50%)으로, 사회과학(13%), 자연과학(8%)이 다음 순이다. 이는 십진분류별 소장도서비율(문학(41%), 사회과학(16%), 역사(8%))과 순서가 유사하나, 비율에서 차이를 보이는 것으로 여겨진다.<br><br/>
